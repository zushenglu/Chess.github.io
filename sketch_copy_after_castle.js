...
var check_warning, w_k_loc = [0,0],b_k_loc = [0,0], last_pawn_move = ["none"];
...
function select_piece(alive_pieces){
  ...
  console.log(gridX,gridY, a.grid[gridY][gridX])
...
function horse_threat_loc(x,y,turn){ // need to fix some bug here lul

  // returns an array of horst threat
  var a0 = ['horse'], target_piece;

  if (x+1 < 8 && y-2 >= 0){ // and make sure it is not a white piece
...
function other_threat_loc(x,y,turn){
    ...
    if (y - i+x > -1 && !tf){
      if (grid[y - i+x][i] instanceof Piece){
        if (grid[y - i+x][i].color != turn && (grid[y+i-x][i].name == "bishop" || grid[y+i-x][i].name == "king" && Math.abs(i-x == 1)|| grid[y+i-x][i].name == "queen" || grid[y+i-x][i].name == "pawn" && grid[y+i-x][i].color == "black" && i-x == 1)){
          a2.push([y-i+x])
          threat_pieces.push(grid[y-i+1][i])
          threat_grid.push(a2);
          tf = true;
        }
        else   {
  ...
  for (let i = y+1;i<8;i++){
    ...
    if (grid[i][x] instanceof Piece){
      if (grid[i][x].color != turn && (grid[y][i].name == "rook" || grid[y][i].name == "queen" || grid[y][i].name == "king" && Math.abs(i-y == 1))){
        a7.push([x,i]);
        threat_grid.push(a7);
...
function is_grid_in_danger(grid_loc,turn){
  ...
  show_routes(grid){
    ...
    */
    var route_array = [];
      ...
      console.log('test for white castle')
    if (this.first_move && this.x == 4){ // white king castle
      console.log("right")
      if (! is_grid_in_danger([this.x+1,this.y],this.color) && grid[this.y][this.x+1] == 0 && ! is_grid_in_danger([this.x+2,this.y],this.color) && grid[this.y][this.x+2] == 0 && grid[this.y][this.x+3].name == "rook" && grid[this.y][this.x+3].color == this.color && grid[this.y][this.x+3].first_move) {
        route_array.push([this.x+2,this.y])
        console.log('white right good')
      }

      console.log("left")
      if (! is_grid_in_danger([this.x-1,this.y],this.color) && grid[this.y][this.x-1] == 0 && ! is_grid_in_danger([this.x-2,this.y],this.color) && grid[this.y][this.x-2] == 0 && ! is_grid_in_danger([this.x-3,this.y],this.color) && grid[this.y][this.x-3] == 0 && grid[this.y][this.x-4].name == "rook" && grid[this.y][this.x-4].color == this.color && grid[this.y][this.x-4].first_move){
        route_array.push([this.x-2,this.y])
        console.log('white left good')
      }
    }

    console.log('test for black castle')
    if (this.first_move && this.x == 3){ // black king castle

      console.log("left")
      if (! is_grid_in_danger([this.x-1,this.y],this.color) && grid[this.y][this.x-1] == 0 && ! is_grid_in_danger([this.x-2,this.y],this.color) && grid[this.y][this.x-2] == 0 && grid[this.y][this.x-3].name == "rook" && grid[this.y][this.x-3].color == this.color && grid[this.y][this.x-3].first_move) {
        route_array.push([this.x-2,this.y])
        console.log("black left good")
      }

      console.log("right")
      if (! is_grid_in_danger([this.x+1,this.y],this.color) && grid[this.y][this.x+1] == 0 && ! is_grid_in_danger([this.x+2,this.y],this.color) && grid[this.y][this.x+2] == 0 && ! is_grid_in_danger([this.x+3,this.y],this.color) && grid[this.y][this.x+3] == 0 && grid[this.y][this.x+4].name == "rook" && grid[this.y][this.x+4].color == this.color && grid[this.y][this.x+4].first_move){
        route_array.push([this.x+2,this.y])
        console.log("black right good")
      }
    }
